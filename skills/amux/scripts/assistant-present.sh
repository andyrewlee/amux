#!/usr/bin/env bash
# assistant-present.sh — augment amux chat payloads with channel-neutral render data.
#
...
TMP_INPUT="$(mktemp "${TMPDIR:-/tmp}/assistant-present.XXXXXX")"
cleanup_tmp() {
...
TARGET_CHANNEL="${AMUX_ASSISTANT_CHANNEL:-}"
