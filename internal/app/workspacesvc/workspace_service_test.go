...
func TestRemoveProjectRegistryError(t *testing.T) {
	...
	reg := &testutil.FakeProjectRegistry{RemoveProjectFunc: func(string) error { return wantErr }}
	svc := New(reg, nil, nil, "")
	project := data.NewProject("/tmp/repo")
...
func TestRemoveProjectCleansMetadataAndSessionsButLeavesFiles(t *testing.T) {
	...
	svc := New(registry, store, nil, filepath.Join(dir, "workspaces"))
	var killed []string
...
func TestRemoveProjectCleansKnownSessionsWithoutMetadataStore(t *testing.T) {
	...
	svc := New(&testutil.FakeProjectRegistry{}, nil, nil, "")
	var killed []string
	svc.killWorkspaceSessions = func(id string) error {
		killed = append(killed, id)
		return nil
...
func TestPruneMissingTemporaryProjectsKeepsNonTemporaryMissingPaths(t *testing.T) {
	...
	registry := &testutil.FakeProjectRegistry{}
	svc := New(registry, nil, nil, "")
...
func TestLoadProjectsReconcilesMetadataOnlyOnInitialLoad(t *testing.T) {
	...
	svc := New(&testutil.FakeProjectRegistry{}, store, nil, filepath.Join(root, "workspaces"))
	var killed []string
	svc.killWorkspaceSessions = func(id string) error {
		killed = append(killed, id)
		return nil
...
func TestLoadProjectsReconciliationKillsSessionsForMissingManagedRoot(t *testing.T) {
	...
	svc := New(registry, store, nil, managedRoot)
	var killed []string
	svc.killWorkspaceSessions = func(id string) error {
		killed = append(killed, id)
		return nil
...
func TestPruneMissingTemporaryProjectCleansOwnedStateButLeavesWorkspaceFiles(t *testing.T) {
	...
	svc := New(registry, store, nil, filepath.Join(root, "workspaces"))
	var killed []string
	svc.killWorkspaceSessions = func(id string) error {
		killed = append(killed, id)
		return nil
