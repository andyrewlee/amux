...
func (d *Daytona) Create(params *CreateSandboxParams, opts *CreateOptions) (*Sandbox, error) {
	...
	if params.AutoDeleteInterval != 0 {
		payload["autoDeleteInterval"] = params.AutoDeleteInterval
	}
	if params.AutoArchiveInterval != 0 {
		payload["autoArchiveInterval"] = params.AutoArchiveInterval
	}
	if params.Ephemeral {
