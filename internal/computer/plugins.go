...
type AgentPlugin interface {
	...
	Validate(sandbox RemoteComputer) error
}
...
func (p *ClaudePlugin) Validate(sandbox RemoteComputer) error {
	resp, err := execCommand(sandbox, "command -v claude", nil)
...
func (p *CodexPlugin) Validate(sandbox RemoteComputer) error {
	resp, err := execCommand(sandbox, "command -v codex", nil)
	if err != nil || resp.ExitCode != 0 {
...
func (p *OpenCodePlugin) Validate(sandbox RemoteComputer) error {
	resp, err := execCommand(sandbox, "command -v opencode", nil)
	if err != nil || resp.ExitCode != 0 {
...
func (p *AmpPlugin) Validate(sandbox RemoteComputer) error {
	resp, err := execCommand(sandbox, "command -v amp || test -x $HOME/.amp/bin/amp", nil)
	if err != nil || resp.ExitCode != 0 {
...
func (p *GeminiPlugin) Validate(sandbox RemoteComputer) error {
	resp, err := execCommand(sandbox, "command -v gemini", nil)
	if err != nil || resp.ExitCode != 0 {
...
func (p *DroidPlugin) Validate(sandbox RemoteComputer) error {
	resp, err := execCommand(sandbox, "command -v droid || test -x $HOME/.factory/bin/droid", nil)
	if err != nil || resp.ExitCode != 0 {
...
func (p *ShellPlugin) Validate(sandbox RemoteComputer) error {
...
func HasCredentials(plugin AgentPlugin, sandbox RemoteComputer) bool {
