...
ROWS += [
    ...
    R("AGT-02", "Agents", "Launch any registered agent",
      "As a user, I want to launch any of the 10 supported agents (claude, codex, opencode, droid, cursor, pi, antigravity, fx, amp, cline), so that I can choose my preferred AI.",
      "Registry lists all 10 in display order with default command + interrupt config; chosen from the assistant picker.",
